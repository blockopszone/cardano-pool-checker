...
def test_find_registered_currently_sharing_relay_hostname(register_data):
...
def test_find_registered_currently_sharing_relay_ipv4(register_data):
    # Define the prefix of the field to test and load expected results
...
def test_find_registered_currently_sharing_relay_ipv6(register_data):
    # Define the prefix of the field to test and load expected results
...
def test_find_registered_currently_sharing_meta_json_homepage(register_data):
    # Define the prefix of the field to test and load expected results
...
def test_find_registered_currently_sharing_meta_url(register_data):
    # Define the prefix of the field to test and load expected results
...
def test_find_registered_currently_sharing_owners(register_data):
    # Define the prefix of the field to test and load expected results
...
def test_find_registered_currently_sharing_reward_addr(register_data):
    # Define the prefix of the field to test and load expected results
