...
def test_find_registered_sharing_relay_hostname(register_data: list[dict[str, Any]]):
    """Tests that function find_registered_sharing_relay_hostname returns the expected result.
...
def test_find_registered_sharing_relay_ipv4(register_data: list[dict[str, Any]]):
    """Tests that function find_registered_sharing_relay_ipv4 returns the expected result.
...
def test_find_registered_sharing_relay_ipv6(register_data: list[dict[str, Any]]):
    """Tests that function find_registered_sharing_relay_ipv6 returns the expected result.
...
def test_find_registered_sharing_meta_json_homepage(register_data: list[dict[str, Any]]):
    """Tests that function find_registered_sharing_meta_json_homepage returns the expected result.
...
def test_find_registered_sharing_meta_url(register_data: list[dict[str, Any]]):
    """Tests that function find_registered_sharing_meta_url returns the expected result.
...
def test_find_registered_sharing_owners(register_data: list[dict[str, Any]]):
    """Tests that function find_registered_sharing_owners returns the expected result.
...
def test_find_registered_sharing_reward_addr(register_data: list[dict[str, Any]]):
    """Tests that function find_registered_sharing_reward_addr returns the expected result.
